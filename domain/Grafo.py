...
grafo.adiciona_vertice("Pinheiros")
grafo.adiciona_vertice("Vila Sônia")
grafo.adiciona_vertice("Osasco")
grafo.adiciona_vertice("Itapevi")
grafo.adiciona_vertice("Paulista")
grafo.adiciona_vertice("Vila Madalena")
grafo.adiciona_vertice("Paraíso")
grafo.adiciona_vertice("República")
grafo.adiciona_vertice("Barra Funda")
grafo.adiciona_vertice("Sé")
grafo.adiciona_vertice("Luz")
grafo.adiciona_vertice("Tucuruvi")
grafo.adiciona_vertice("Jundiaí")
grafo.adiciona_vertice("Jabaquara")
grafo.adiciona_vertice("Tamanduateí")
grafo.adiciona_vertice("Brás")
grafo.adiciona_vertice("Rio Grande da Serra")
grafo.adiciona_vertice("Jardim Colonial")
grafo.adiciona_vertice("Artur Alvim")
grafo.adiciona_vertice("Estudantes")
grafo.adiciona_vertice("Aracaré")
grafo.adiciona_vertice("Engº Goulart")
grafo.adiciona_vertice("Guarulhos")
...
grafo.adiciona_aresta(grafo.retorna_vertice("Santo Amaro"), grafo.retorna_vertice("Pinheiros"), 8)
grafo.adiciona_aresta(grafo.retorna_vertice("Santo Amaro"), grafo.retorna_vertice("Paraíso"), 14)
grafo.adiciona_aresta(grafo.retorna_vertice(""), grafo.retorna_vertice(""), )
grafo.adiciona_aresta(grafo.retorna_vertice(""), grafo.retorna_vertice(""), )
grafo.adiciona_aresta(grafo.retorna_vertice(""), grafo.retorna_vertice(""), )
grafo.adiciona_aresta(grafo.retorna_vertice(""), grafo.retorna_vertice(""), )
grafo.adiciona_aresta(grafo.retorna_vertice(""), grafo.retorna_vertice(""), )
